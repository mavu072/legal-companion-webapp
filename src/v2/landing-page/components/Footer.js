    ...
    >
      ...
      >
        ...
        >
          <IconButton
            color="inherit"
            href="https://github.com/mavu072/legal-companion-webapp"
            aria-label="GitHub"
            sx={{ alignSelf: 'center' }}
          >
            <FacebookIcon />
          ...
          {/* <IconButton
            color="inherit"
            href="https://x.com/AILegalCompanion"
            aria-label="X"
            sx={{ alignSelf: 'center' }}
          >
            <TwitterIcon />
          ...
          <IconButton
            color="inherit"
            href="https://www.linkedin.com/company/ai-legal-companion"
            aria-label="LinkedIn"
            sx={{ alignSelf: 'center' }}
          >
            <LinkedInIcon />
